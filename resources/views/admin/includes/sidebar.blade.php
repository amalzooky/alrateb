<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
 ...
 <li class=" nav-item"><a href="#"><i class="la la-television">
         ...
         data-i18n="nav.templates.main">البث المباشر </span></a>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">ويبنر </a>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">الصور المتحركه</a>
                        <ul class="menu-content">
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">الخدمات </a>
                        <ul class="menu-content">
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">من نحن </a>
                        <ul class="menu-content">
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">أهدافنا </a>
                        <ul class="menu-content">
